  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Communicate with landlords</p>
      </div>
        ...
        <div className="lg:col-span-1 bg-white rounded-lg shadow-md overflow-y-auto max-h-96">
          {conversations.length > 0 ? (
            conversations.map((conversation) => (
              ...
              >
                <p className="font-semibold text-text">{conversation.landlord?.name}</p>
          ...
          {selectedConversation ? (
            <div>
              <h2 className="text-xl font-bold text-text mb-4">
                Chat with {selectedConversation.landlord?.name}
              </h2>
